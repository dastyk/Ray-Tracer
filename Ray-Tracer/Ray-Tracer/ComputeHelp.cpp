...
bool ComputeShader::Init(TCHAR* shaderFile, TCHAR* blobFileAppendix, const char* pFunctionName, D3D10_SHADER_MACRO* pDefines,
...
ComputeBuffer* ComputeWrap::CreateBuffer(COMPUTE_BUFFER_TYPE uType,
	UINT uElementSize, UINT uCount, bool bSRV, bool bUAV, VOID* pInitData, bool cpuAccess, bool bCreateStaging, const char* debugName)
{
...
ID3D11Buffer* ComputeWrap::CreateStructuredBuffer(UINT uElementSize, UINT uCount,
									bool bSRV, bool bUAV, VOID* pInitData, bool cpuAccess)
{
...
ComputeTexture* ComputeWrap::CreateTexture(DXGI_FORMAT dxFormat, UINT uWidth,
	UINT uHeight, UINT uRowPitch, VOID* pInitData, bool bCreateStaging, const char* debugName)
{
...
ID3D11Buffer* ComputeWrap::CreateConstantBuffer(UINT uSize, VOID* pInitData, bool write, const char* debugName)
{
	...
	cbDesc.CPUAccessFlags = write ? D3D11_CPU_ACCESS_WRITE : 0;
	cbDesc.MiscFlags = 0;
	cbDesc.StructureByteStride = 0;
	cbDesc.Usage = write ? D3D11_USAGE_DYNAMIC : D3D11_USAGE_DEFAULT;
...
void ComputeWrap::SetDebugName(ID3D11DeviceChild* object, const char* debugName)
{
#if defined( DEBUG ) || defined( _DEBUG )
...
ComputeShader* ComputeWrap::CreateComputeShader(TCHAR* shaderFile, TCHAR* blobFileAppendix, const char* pFunctionName, D3D10_SHADER_MACRO* pDefines)
{
